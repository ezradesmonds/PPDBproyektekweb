...
<head>
    ...
    <title>Register - PPDB Sekolah Impian</title>
    ...
    <div class="register-container py-5">
        <div class="card register-card border-0">
            <div class="card-header register-header text-center py-4">
                <h2 class="fw-bold mb-0"><i class="fas fa-user-plus"></i> Daftar Akun Baru</h2>
                <p class="mb-0">Langkah pertama untuk menjadi siswa Sekolah Impian</p>
            </div>
